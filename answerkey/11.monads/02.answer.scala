...
// an anonymous class inline, inside parentheses, and project out its type
// member `f`. This is sometimes called a "type lambda", since it's very similar
// to a type-level anonymous function.
