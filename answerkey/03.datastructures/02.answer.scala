...
// returning a value just means this bug will be discovered later, further from
// the place where it was introduced.
//
// It's generally good practice when pattern matching to use `_` for any
// variables you don't intend to use on the right hand side of a pattern. This
