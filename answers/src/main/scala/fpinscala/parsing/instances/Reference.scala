...
import fpinscala.parsing.ReferenceTypes.*
...
object Reference extends Parsers[Parser] {
  import fpinscala.parsing.ReferenceTypes.Result.*
   ...
   *  monolithic loop. This avoids stack overflow errors for most grammars.
   */
